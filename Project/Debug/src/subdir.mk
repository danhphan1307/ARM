...
src/%.o: ../src/%.cpp
	...
	arm-none-eabi-c++ -D__NEWLIB__ -DDEBUG -D__CODE_RED -DCORE_M3 -D__USE_LPCOPEN -DCPP_USE_HEAP -D__LPC15XX__ -I"/Users/danh/Documents/LPCXpresso_8.2.2/workspace/lpc_board_nxp_lpcxpresso_1549/inc" -I"/Users/danh/Documents/LPCXpresso_8.2.2/workspace/lpc_chip_15xx/inc" -I"/Users/danh/Documents/LPCXpresso_8.2.2/workspace/Lab 5.2/src" -I"/Users/danh/Documents/LPCXpresso_8.2.2/workspace/Lab 5.2/freertos/inc" -O0 -fno-common -g3 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fdata-sections -fno-rtti -fno-exceptions -mcpu=cortex-m3 -mthumb -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
